    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('perkembangan.create')); ?>">    Data Perkembangan Anak   </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('consultation.index')); ?>">    Konsultasi   </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('imunisasi.index')); ?>">   Imunisasi   </a>
                </li>
            </ul>
        </div>
    </nav>
...
</html><?php /**PATH C:\xampp\htdocs\laravel-admin-project\laravel-admin-project 17 Desember 2024\resources\views/dashboard.blade.php ENDPATH**/ ?>