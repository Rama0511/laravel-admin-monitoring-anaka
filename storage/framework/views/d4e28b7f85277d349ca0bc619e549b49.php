...
<body>
    <div class="container mt-5">
        ...
        <p class="text-center">Maaf, data perkembangan anak untuk bulan <strong><?php echo e($bulan); ?></strong> tidak tersedia.</p>
        <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Kembali ke Dashboard</a>
    </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\laravel-admin-project\resources\views/not_found.blade.php ENDPATH**/ ?>